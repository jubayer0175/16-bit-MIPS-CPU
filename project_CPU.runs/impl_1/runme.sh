...
HD_PWD='C:/Users/mzm0175/OneDrive - Auburn University/Academics/Compuer architecture/Project/project_CPU_RET_fixed _impl_seven_segment - demo/project_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_PC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Test_PC.tcl -notrace
