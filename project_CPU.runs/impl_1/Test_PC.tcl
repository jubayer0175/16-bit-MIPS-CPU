...
set rc [catch {
  ...
  open_checkpoint Test_PC_routed.dcp
  ...
  catch { write_mem_info -force Test_PC.mmi }
  write_bitstream -force Test_PC.bit 
  catch {write_debug_probes -no_partial_ltxfile -quiet -force debug_nets}
  catch {file copy -force debug_nets.ltx Test_PC.ltx}
