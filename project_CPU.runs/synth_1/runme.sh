...
HD_PWD='C:/Users/mzm0175/OneDrive - Auburn University/Academics/Compuer architecture/Project/project_CPU_RET_fixed _impl_seven_segment - demo/project_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Test_PC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Test_PC.tcl
